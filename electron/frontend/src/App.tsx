...
const Editor = React.lazy(() => import('./components/Editor' as any) as any);
const Preview = React.lazy(() => import('./components/Preview' as any) as any);
const Notification = React.lazy(() => import('./components/Notification' as any) as any);
const ContextMenu = React.lazy(() => import('./components/ContextMenu' as any) as any);
const SettingsModal = React.lazy(() => import('./components/SettingsModal' as any) as any);
